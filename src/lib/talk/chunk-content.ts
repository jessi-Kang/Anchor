 ...
 * 그래서 돌려주는 것은 문장 하나, 그 안의 덩어리 하나, 그리고 말끝의 태도를 짚는 한 줄뿐이다.
...
- attitude: 한국어 말끝이 무슨 태도인지. 내적 태도 / 기억 / 의도 / 능력 / 제안 / 원인 / 설명 / 확인 / 강조 중 하나.
- note: 한 줄. 형식은 "\\"<한국어 말끝>\\"은 <태도>. 영어로는 이 덩어리 하나로". 말끝은 사용자가 쓴 문장에서 그대로 따온다.
...
export function fallbackContent(situation: string): ChunkContent {
  ...
  return {
    ...
    chunk: line,
    attitude: "설명",
    note: "영어 문장은 목소리 키가 있을 때 만들어져. 지금은 쓴 그대로 보여 줄게.",
  };
}
