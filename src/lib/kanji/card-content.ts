 ...
 *
 * 손으로 적은 다섯 장(世 車 日 力 必)이 이미 답을 하고 있었다. 전부 **모양**으로 푼다 —
 * "해의 모양", "바퀴 달린 수레를 위에서 본 모양". 그래서 새 규칙을 지어내지 않고 **그 다섯 장이
 * 하던 것을 그대로 적었다.** 부품이 있는 1,679자의 문안은 이 갈래를 안 지나므로 그대로다.
 *
...
- 부품이 "없음(한 덩어리)" 이면 **부품을 지어내지 말고 글자의 모양**을 한 구절로 적는다. 예: 日 → "해의 모양", 車 → "바퀴 달린 수레를 위에서 본 모양", 世 → "열(十)이 셋, 서른 해". 뜻을 먼저 말하지 않는다 — 그 모양에서 question 이 출발한다.
