  ...
  ja: {
    ...
    /*
      ...
      **이 자료로는 「아는 것 → 다음 것」 한 줄이 여섯 번째 카드에서야 선다. 버그가 아니다.**
      앞 다섯은 이유 자리에 **자료를 대는 대체 문구**가 선다(`docs/FLOW.md:82` 끝: "다음은 支.
      아침 기사에서."). 화면이 비는 게 아니라 **주어로 댈 판정된 한자가 아직 없는 것**이다.
      ...
      **27자**인데(動 務 加 男 助 労 働 効 … `docs/SPEC.md:183` 의 加·助·動 이 그 안에 있다) 그중
      ...
      **그 판정은 이미 났다.** `CLAUDE.md:51`: 「고르는 함수는 `inputs` 가 아니라 `user_node_state`
