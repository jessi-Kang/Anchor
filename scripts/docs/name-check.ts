 ...
 *
 * **한 글자는 그대로 안 센다.** 이 레포의 한 글자 「」는 서른 개인데 다 **한자와 소리**다
 * (「김」·「량」·「류」…). 절 이름이 아니라 **이야기하는 대상**이라, 세기 시작하면 그날부터
 * 헛것이 쏟아진다. **안 재는 줄에 이 바닥도 같이 적는다** — 정규식 안에만 있으면 출력만 읽는
 * 사람에게는 「안 재는 것 목록에 없는 안 재는 것」이 된다.
 *
...
console.log("안 재는 것 ②: 한 글자 이름. 이 레포의 한 글자 「」는 절 이름이 아니라 한자·소리다.");
