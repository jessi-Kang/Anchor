...
| --- | --- | --- | --- | --- |
| MVP | 3주 | 두 축. (1) 영어 대화 루프 초기판: 오늘 못 한 말 한 줄 → 덩어리 → 듣고 따라 말하고 곡선 비교. (2) 일본어 한자 발견 카드 + 앵커 그래프 | "추측 → 확인"이 암기보다 남는다. 곡선 비교가 말하기를 바꾼다 | **자료** 재만남 인식률 70%(예문 재만남은 합치지 않고 옆에 나란히 낸다 — `docs/MEASURE.md` 1장), 같은 덩어리 5회차 **원어민 대비** 곡선 일치도 상승 |
