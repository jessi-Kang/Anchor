...
| 2. 목적 | 언어 3개 각각 "어디서 쓰나" 한 번 탭 (업무, 수업, 콘텐츠, 여행). 대화는 기본이라 묻지 않음 | 상황을 고르는 것이지 수준을 고르는 게 아님 |
| 3. 가나 읽기 | 가나 6개를 보고 소리 내서 읽기. 못 읽으면 가나 모듈로 | "읽을 수 있다"고 말하는 대신 실제로 읽는다 |
| 4. 영어 씨앗 3분 | 빈도 높은 어근·덩어리 한 장씩. 뜻을 먼저 떠올리고 → 뒤집어 확인 → "맞았다 / 틀렸다" | "아는가?"가 아니라 "떠올렸는가?"를 묻는다. 답을 본 뒤 판정하므로 과대평가가 어렵다 |
