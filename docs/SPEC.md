...
MVP 통과 기준 둘은 **같은 것을 두 번 만나야** 나오는 숫자다. 재만남 인식률은 2주 전 한자를 다시 읽어야 나오고, 곡선 일치도는 같은 덩어리를 다섯 번 말해야 나온다. 지금 선 열일곱 화면은 전부 **처음**만 지어져 있다 — 자료도 처음 넣는 길, 카드도 처음 여는 길, 덩어리도 처음 만드는 길. 어제 것으로 돌아가는 길이 어느 화면에도 없다. 화면을 더 지어도 잴 것이 안 생긴다.

그래서 이 단계는 기능을 늘리는 단계가 아니라 **이미 있는 화면에 두 번째로 들어가는 길을 내는 단계**다.

스페인어 축은 그다음이다. 지금 막힌 것은 일본어 축의 문제가 아니라 세 축에 다 있는 구멍이고(막힌 셋 중 둘이 영어 축이다), 축을 하나 더 켜면 같은 구멍이 하나 더 생긴다. 세 언어가 다 통하는지는 v1.5 가 이미 검증 항목으로 들고 있으므로 버려지는 것이 아니라 자리가 있다.
